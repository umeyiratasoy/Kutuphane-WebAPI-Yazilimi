...
//        {
//            ColorManager colorManager = new ColorManager(new EfColorDal());
//            var color = new Color { Id = 2, ColorName = "Blue" };
...
//        {
//            ColorManager colorManager = new ColorManager(new EfColorDal());
//            var color = new Color { Id = 4, ColorName = "Blue" };
...
//        {
//            ColorManager colorManager = new ColorManager(new EfColorDal());
//            var color = new Color { Id = 5, ColorName = "Yellow" };
...
//        {
//            BrandManager brandManager = new BrandManager(new EfBrandDal());
//            var brand = new Brand { Id = 2, BrandName = "Honda" };
...
//        {
//            BrandManager brandManager = new BrandManager(new EfBrandDal());
//            var brand = new Brand { Id = 4, BrandName = "Honda" };
...
//        {
//            BrandManager brandManager = new BrandManager(new EfBrandDal());
//            var brand = new Brand { Id = 5, BrandName = "Mercedes" };
